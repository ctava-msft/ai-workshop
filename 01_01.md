...
2. Open the Azure AI Foundry Playground to interact with a language model.
    ...
    If a language model hasnt been previously deployed, click on Create a Deployment:
    ![create deployment.](images/deployment-needed.png)

    Choose a language model (GPT-4) and click Confirm:
